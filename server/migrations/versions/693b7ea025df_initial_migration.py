...
Revision ID: 693b7ea025df
Revises: 
Create Date: 2024-10-25 20:56:54.447485
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['house_id'], ['houses.id'], name=op.f('fk_transactions_house_id_houses')),
